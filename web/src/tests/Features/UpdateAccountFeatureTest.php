...
class UpdateAccountFeatureTest extends TestCase
{
    ...
    public function test_update_account_feature()
    {
        $url = '/api/v1/accounts/' . $this->account->id;
        $response = $this->json('PUT', $url, ['relative_dir' => 'new_dir'], $this->headers)
            ->assertStatus(200)
            ->assertJsonStructure([
                'data' => [
                    'id',
    ...
    public function test_update_account_feature_not_found()
    {
